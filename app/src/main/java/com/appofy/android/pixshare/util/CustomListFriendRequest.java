 ...
 */
public class CustomListFriendRequest extends ArrayAdapter<String> {
    private final Activity context;
    private final ArrayList<String> web;
    private final ArrayList<Bitmap> imageId;

    public CustomListFriendRequest(Activity context,
                      ArrayList<String> web, ArrayList<Bitmap> imageId) {
        super(context, R.layout.friend_request_list_item, web);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.friend_request_list_item, null, true);
